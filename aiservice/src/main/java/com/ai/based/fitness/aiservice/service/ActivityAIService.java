...
//      log.info("PARSED RESPONSE from AI: {}", jsonContent);
  ...
  private List<String> extractSuggestions(JsonNode suggestionsNode) {
    ...
    return suggestions.isEmpty() ? Collections.singletonList(
  ...
  private List<String> extractImprovements(JsonNode improvementsNode) {
    ...
    return improvements.isEmpty() ? Collections.singletonList(
            "No Specific Improvements provided.") :
            improvements;
  }

  private void addAnalysisSection(StringBuilder fullAnalysis, JsonNode analysisNode, String key,
          String prefix) {
